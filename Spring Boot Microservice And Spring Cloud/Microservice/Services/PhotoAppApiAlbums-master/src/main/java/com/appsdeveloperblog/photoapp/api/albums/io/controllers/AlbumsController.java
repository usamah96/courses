...
public class AlbumsController {
    ...
    public List<AlbumResponseModel> userAlbums(@PathVariable String id) throws Exception{

        if(id.equals("200")) throw new RuntimeException("Id 200 Nahe Ho skti"); // For Feign Error Decoder
